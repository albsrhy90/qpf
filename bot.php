...
*/
ob_start();
$API_KEY = "6939044877:AAEFoD_J04mooSwYnBQiVpWfg4BzwDEMb8Y";//توكنك
$buy = "@ncufjdnxj";// معرفك
$sudo = "6972030320";//ايديك
$admin = "$sudo";// ماتغير شي
$idBot = "6939044877";// ايدي بوتك
$admmm = $sudo;//ماتغير شي
$Dev = array("$sudo", "" );
$userrr = "jsxudhdhsbot";// معرف بوتك بدون @
...
$Dev = array("$admmm","6972030320");// حط ايدي مطور ثاني بدل الاصفار
$channel = "sourcehamdy";
$token = API_KEY;
